...
<?php 
    ...
    <?php
        ...
        <?php 
			if(isset($_GET['vendorid']))
			{
                $data = $mysqli->query("select `v_id`, `cos_id`, `v_name`, `business_name`, `contact_person`, `v_mobile`, `v_whatsapp`, `gst_no`, `v_address`,`active`  from e_vendor_details where cos_id = '$cos_id' and v_id=".$_GET['vendorid']."")->fetch_assoc();
			?>
