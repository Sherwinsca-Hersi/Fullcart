...
<div class="sidemenu">
    ...
    if($_SESSION['role']==5 || $_SESSION['role']==9){
        ?>   
        <div class="menu-item">
            <a href="employee.php" class="menu-link" data-url="employee.php">Employees/Roles</a>
        </div>  
    <?php
    }
    if($_SESSION['role']==5 || $_SESSION['role']==7 || $_SESSION['role']==9){
    ...
    ?>   
        ...
        <div class="menu-item">
            ...
            <div class="submenu">
                ...
                <a href="employee.php" class="submenu-link" data-url="employee.php">Employees/Roles</a>
