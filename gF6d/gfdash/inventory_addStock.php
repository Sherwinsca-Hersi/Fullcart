...
<?php 
    ...
    ?>
        ...
        if(isset($_GET['productid']) && isset($_GET['batch_id'])){
            $stock_data = $mysqli->query("SELECT pd.p_title,pd.p_variation,pd.unit,ps.s_batch_no,ps.qty,ps.s_expiry_date,ps.supplier_id,
                                        ps.s_mrp,ps.in_price,ps.s_out_price,ps.invoice_no,ps.stock_bill
       ...
       <div class="product_details">
        <?php $product_details=$mysqli->query("SELECT p_title,id,p_variation,unit FROM `e_product_details` WHERE cos_id='$cos_id' AND active=1 AND id=".$_GET['productid']." GROUP BY id")->fetch_assoc(); ?>
        ...
        <form class="addproduct_form" method="post" action="com_ins_upd.php"  enctype="multipart/form-data" autocomplete="off"  id="myForm" onsubmit="return validateForm()">
            <div class="grid_col">
                ...
                <div class="form-div">
                            ...
                            <div>
                                <div class="batch_div">
                                    <input type="text" name="batch_no" class="input_style" placeholder="Enter Batch No" id="batch_no" value="<?php echo $stock_data['s_batch_no'];?>" maxlength="10" required>
    ...
    document.getElementById("generateBatchNo").addEventListener("click", function() {
        ...
        xhr.send();
                    ...
                    <div class="form-div">
                        <label for="tstock" class="form-label">Stock Count</label>
                        <div>
                            <input type="number" name="tstock" id="tstock" class="input_style" placeholder="Enter Stock Count"  value="<?php echo $stock_data['qty'];?>"  required>
                        </div>
                    </div>
                    <div class="form-div">
                ...
                <div class="grid-col-2">
                    ...
                    <div class="form-div">
                        ...
                        <div>
                            <input type="text" name="invoice_no" class="input_style" maxlength="10" placeholder="Enter Invoive No" value="<?php echo $stock_data['invoice_no'];?>">
                        </div>
                    </div>
        ...
        xhr.send();
                    ...
                    <div class="grid-col-2">
                        ...
                        <div class="form-div">
                            ...
                            <div>
                                <input type="text" name="invoice_no" maxlength="10" class="input_style" placeholder="Enter Invoive No">
                            </div>
                        </div>
                        <div class="img_input">
                            <div class="file_upload">
...
function validatePrice() {
    ...
    var outPrice = parseFloat(document.getElementById('outprice').value);
    ...
    if (mrp === 0) {
        ...
        // Validate Outprice only if MRP is not 0
        if (outPrice > mrp) {
