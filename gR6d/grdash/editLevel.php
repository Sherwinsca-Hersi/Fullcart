...
<?php 
    ...
    <div class="addproduct_rightbar container">
        ...
        <?php 
			if(isset($_GET['productid']))
			{
				$data = $mysqli->query("SELECT `id`, `cos_id`, `sku_id`, `hsn_code`, `barcode`, `cat_id`,
                 `sub_cat_id`, `p_img`, `imgs`, `p_title`, `brand`, `p_variation`, `unit`, `type`,
                 `p_desc`, `is_loose`, `reorder_level`, `emergency_level`, `location`, `godown_location`
