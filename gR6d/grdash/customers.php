...
?></td>
                        <?php 
                            $cust_order_query=$mysqli->query("SELECT created_ts,subtotal FROM `e_normal_order_details` WHERE cos_id='$cos_id' AND u_id=".$customer_detail['id']." ORDER BY created_ts DESC LIMIT 1")->fetch_assoc();
                        ?>
