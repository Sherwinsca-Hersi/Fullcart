        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (obtainedBtns.length > 0) {
                for (var i = 0; i < obtainedBtns.length; i++) {
                    obtainedBtns[i].style.backgroundColor = "green";
    ...
    <div class="orders_rightbar container">
        ...
        <!-- <div class="date_sect">
            ...
            <p class="datepicker dateRange">
                ...
                <span id="end_icon" class="date-icon"><img src="../assets/images/date_icon.png" alt="date-icon-img"><input type="date"></span>
                                    ...
                                    <?php
                                       ...
                                       <thead class="table_head">
                                            <tr>
                                                ...
                                                <?php if (!(isset($_POST['completed'])||isset($_POST['out_delivery'])|| isset($_POST['all_orders']) || $currentStatus=='all_orders' || isset($_POST['processing']))): ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php if((isset($_POST['processing'])) || $currentStatus=='processing' ):?>
                                                    <td><?php 
                                                            $pakager=$mysqli->query("SELECT  s_name FROM `e_salesman_details` WHERE cos_id='$cos_id' AND id=".$online_order['salesman_id']."")->fetch_assoc();
                                                            echo $pakager['s_name']??'N/A';
                                                        ?>
                                                    </td>
                                                <?php endif; ?>
                                                <?php if (isset($_POST['out_delivery']) || isset($_POST['completed'])|| isset($_POST['all_orders'])):
...
?>
 ...
 document.addEventListener('DOMContentLoaded', function() {
        ...
        // var orderId = "<?php echo $online_order['id']; ?>";
        // console.log("Order ID from PHP: " + orderId); // Ensure this logs correctly

        // // Fetch the salesmen data if not already loaded
        ...
        //     // Include the order_id in the request URL
        //     xhr.open("GET", "fetch_salesman.php?order_id=" + encodeURIComponent(orderId), true);
        //     xhr.send();
        // }
...
?>
 ...
 document.addEventListener('DOMContentLoaded', function() {
            ...
            selectElement.addEventListener('change', function() {
                ...
                window.location.href = hrefValue;
                                                        ...
                                                        <?php elseif ($currentStatus=='pending'): ?>
                                                            <!-- <td class="action_def">
                                                                <a href="com_ins_upd.php?dsid=<?php echo $online_order['id']; ?>&status=1 + &currentStatus=pending" class="action_btn">Start Packing</a>
                                                            </td> -->
                                                            <td class="action_def">
                                                        <div class="form-group">
    <a href="#" class="myLink order-action" id="myLink" data-dsid="<?php echo $online_order['id']; ?>"></a>
    <select class="form-control select2-single salesman-select mySelect" id="db_select" required>
        <?php
        $query = "SELECT id, s_name FROM e_salesman_details WHERE cos_id = '$cos_id' AND role = 3 AND active != 2 AND active != 0";
        $result = $mysqli->query($query);
    if ($result && $result->num_rows > 0) {
?>
<option value="0" <?php if($online_order['salesman_id']==0){
                                    ...
                                    <form id="statusForm" method="post" action="orders.php">
                                       ...
                                       <thead class="table_head">
                                            <tr>
                                                ...
                                                <?php endif; ?>
                                                <?php if((isset($_POST['processing'])) || $currentStatus=='processing' ):?>
                                                    <th>Packager Assigned</th>
                                                <?php endif; ?>
                                                <?php if (isset($_POST['out_delivery']) || isset($_POST['completed']) || isset($_POST['all_orders'])):
                                                    if(!isset($_POST['all_orders'])){
                                                        ?>
                                                        <th>Delivery Person Assigned</th>
                                                        <?php
                                                    }
                                                    ?>
                                                    <th>Current Status</th>
                                                <?php endif; ?>
                                                <th>Previous Action Done on</th>
                                                <?php if (!(isset($_POST['completed'])||isset($_POST['out_delivery'])|| isset($_POST['all_orders']) || isset($_POST['processing']))): ?>
                                                    <th class="remove_arrow">Action</th>
                                                <?php endif; ?>
                                                <th class="remove_arrow">View Order Details</th>
