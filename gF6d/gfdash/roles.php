    ...
    <div class="banner_rightbar container">
        ...
        <div class="searchbar_sect">
            <div class="search_div">
                <input type="text" name="search_input" placeholder="Search Role Name.." id="customSearchBox" class="searchInput">  
            </div>
            <div class="addBanner_sect">
                <a href="addRole.php" class="export_btn employee_link"> Add Roles </a>
        ...
        <table rules='all' cellpadding='50px' cellspacing='50px' class="table_style display" id="example" data-disablesortingcolumns="0,2">
                    ...
                    ?>
                    <tr class="<?php echo ($i % 2 === 0)? 'teven' : 'todd';?>" onclick="redirect(this, <?php echo $role_detail['id'];?>)">
                        <td><input type="checkbox" class="check_value checkbox_tdef" name="checkbox" data-id="<?php echo $role_detail['id']; ?>">&emsp;<?php echo $i; ?></td>
                        <td><?php echo $role_detail['role_title']; ?></td>
                        <td><?php echo $role_detail['role_desc']; ?></td>
                        <?php if($role_detail['active'] == 1) { ?>
