...
<?php 
    ...
    <div class="addBanner_rightbar container">
        ...
        <?php 
			if(isset($_GET['orderid']))
			{
				$data = $mysqli->query("SELECT `id`, `cos_id`, `u_id`, `invoice_no`, `o_date`, `p_method_id`, `address`, `landmark`, `d_charge`, 
                                        ...
                                        FROM `e_normal_order_details` WHERE p_method_id=1 and cos_id='$cos_id' and active=6 and id=".$_GET['orderid']." order by id")->fetch_assoc();
			?>
