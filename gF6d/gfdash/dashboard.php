...
<div class="rightbar container">
    ...
    <div class="card-style">
        <a href="products.php" class="card_link">
        ...
        <a href="orders.php" class="card_link">
            <div class="sales_card">
                ...
                <div class="card-text">
                    ...
                    <h3>Total Orders</h3>
                    <div><h3><?php echo " " . $instore_orders + $online_orders; ?></h3></div>
                </div>
            </div>
        </a>
        <a href="customers.php" class="card_link">
        ...
        <a href="revenue.php" class="card_link">
            <div class="revenue_card">
                ...
                <div class="card-text">
                    ...
                    <div><h3>
                            <?php
                            $sales_total = $online_sales['order_total'] + $instore_sales['order_total'];
                            echo '₹' . formatIndianRupees(number_format((float)$sales_total, 2, '.', ''));
                            ?>
                            <!-- <?php
    ...
    <div class="grid-container">
        ...
        <div class="grid_main_div">
            ...
            <div class="grid_card-4">
                <a href="unsold_products.php" class="view_btn">View More...</a>
        ...
        <div class="grid_main_div">
            <div class="grid_card_heading">
                ...
                <div id="button-selector2">
                    <button data-value="byRevenue">By Revenue</button>
                    <button data-value="byPurchase">By Recent Purchase</button>
                    <button data-value="byOrders">By No of Orders</button>
                </div>
                <!-- <h5>Total Customers: <?php echo $total_customers; ?></h5> -->
            </div>
            <div class="grid_card-6">
                <table rules='all' cellpadding='50px' cellspacing='50px' class="table_style" id="cust_table_dash">
    ...
    <div class="grid_recent_saled">
        ...
        <!-- <div class="recent_saled_card">
            <table rules='all' cellpadding='50px' cellspacing='50px' class="table_style" id="example"
                   data-disable-paging="true" data-disablesortingcolumns="2,3">
                <thead class="table_head">
                <th>Order Id</th>
                <th>Invoice No</th>
        ...
        <div class="recent_saled_card">
    <table rules='all' cellpadding='50px' cellspacing='50px' class="table_style" id="example" data-disable-paging="true" data-disablesortingcolumns="2,3">
        <thead class="table_head">
            <tr>
                <th>Order Id</th>
                <th>Invoice No</th>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const unsoldProd = [
            ...
            ?>
            {
                name: '<?php echo $unsold_product['p_title'];?>',
                stock: '<?php echo $unsold_product['unsold_qty'];?>',
                variation: '<?php echo $unsold_product['p_variation'];?>',
                unit: '<?php echo $unsold_product['unit'];?>',
                lowStockThreshold: 23,
                color: '<?php echo $unsold_progress_color[$i]; ?>'
            },
            <?php
            $i++;
            endforeach;
    ...
    $(document).ready(function () {
        function initializeDataTable(tableId) {
            ...
            if (tableElement.length) {
                ...
                var disablePaging = tableElement.data('disable-paging') === true || tableElement.data('disable-paging') === "true";
